...
*/
    ...
    function r() {
        ...
        for (var a = t, b = {}, c = 0; c < a.length; ++c)
...
*/
    ...
    function K(a, b) {
        ...
        if (b === "protocol" || b === "port")
            ...
            a.protocol = L(a.protocol) || L(C.location.protocol);
    ...
    function M(a, b, c) {
        ...
        case "url_no_fragment":
            ...
            c = c < 0 ? a.href : a.href.substring(0, c));
        ...
        case "path":
            ...
            a = a.pathname.substring(0, 1) === "/" ? a.pathname : "/" + a.pathname;
    ...
    function ma(a) {
        ...
        return function(b) {
            ...
            k.length >= 4 && k.substring(0, 4) === "_gl=" ? e = 4 : (f = k.indexOf("&_gl="),

            f > 0 && (e = f + 3 + 2));

            e < 0 ? e = void 0 : (f = k.indexOf("&", e),

            e = f < 0 ? k.substring(e) : k.substring(e, f));
    ...
    function ra(a, b) {
        ...
        function c(m, l, k) {
            ...
            d ? (W(3) || W(1) || !l) && sa("_gl", m, a, l, k) : ua("_gl", m, a, l, k))
    ...
    q("google_tag_data.tcBridge.registerUa", function(a, b) {
        ...
        d.destinations = [b]) : c.destination[a] = {
...
(function() {
    ...
    $c.prototype.union = function(a) {
        ...
        for (var b = this.C.slice(), c = 0; c < a.C.length; c++)
    ...
    var aa = window.GoogleAnalyticsObject, Y;

    if (Y = aa != void 0)

        Y = (aa.constructor + "").indexOf("String") > -1;
    ...
    var ea = function(a) {
      ...
      , qa = function(a) {
        ...
        if (b = a != void 0)
            ...
            b = (a.constructor + "").indexOf("String") > -1;
      ...
      , ra = function() {
        ...
        for (var a = O.navigator.userAgent + (M.cookie ? M.cookie : "") + (M.referrer ? M.referrer : ""), b = a.length, c = O.history.length; c > 0; )
      ...
      , za = function(a, b) {
        ...
        if (b.length == 1 && b[0] != null && typeof b[0] === "object")
    ...
    var Qa = window
      ...
      , G = function(a) {
        ...
        if (b && b.ioo && b.ioo() || Za.documentElement.hasAttribute("data-google-analytics-opt-out") || a && Qa["ga-disable-" + a] === !0)
        ...
        for (c = 0; c < b.length; c++) {
            ...
            e && e == "AMP_TOKEN" && ((d = d.slice(1).join("=").replace(/^\s*|\s*$/g, "")) && (d = decodeURIComponent(d)),
    ...
    function ob(a, b, c) {
        ...
        for (var e = 0; e < b.length; e++) {
            ...
            if (g[0] !== "1" || c && g.length < 3 || !c && g.length !== 3)
    ...
    ;var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//, Ue = /^(?:www\.|m\.|amp\.)+/, Ub = [], da = function(a) {
        ...
        if (c == "$OPT_OUT" || c == "$ERROR" || G(b))

            return J(62),

            !1;

        if (!ja.test(M.referrer) && c == "$NOT_FOUND")
        ...
        a: {
            ...
            if (ja.test(M.referrer)) {
                ...
                b: {
                    ...
                    d = (d = e == "s" ? d[3] : e) ? decodeURIComponent(d) : d;
      ...
      , oc = function(a, b, c) {
        ...
        if (b.length === 0)
            ...
            case "g":
                ...
                (b = b.substring(1)) && /^[a-z.]{1,6}$/.test(b) && wc("https://www.google.%/ads/ga-audiences".replace("%", b), a.google, ua);
    ...
    function Ja(a) {
        ...
        if (a.get(Ka) != 100 && La(P(a, Q)) % 1E4 >= R(a, Ka) * 100)
    ...
    function Pa(a) {
        ...
        ue.map(function(c, d) {
            ...
            c != void 0 && c != d.defaultValue && (typeof c == "boolean" && (c *= 1),
    ...
    function Sa(a) {
        ...
        default:
            ...
            b == "image" ? wc(e, l, ca) : b == "xhr" && wd(e, l, ca) || b == "beacon" && x(e, l, ca) || ba(e, l, ca)) : ba(e, l, ca) : ca && ca()
        ...
        if (rf(a))
            ...
            k = sf[l])
                ...
                for (l = 0; l < k.length; ++l)
                    ...
                    (ca = tf(k[l]).q) && ca.length < 30 && ca.push && ca.push(uf(a));

            else

                vf[l] = vf[l] || [],

                vf[l].length < 30 && vf[l].push(uf(a))
    ...
    function cd() {
        ...
        if (O.navigator && O.navigator.loadPurpose == "preview")
    ...
    function Pe(a) {
        ...
        try {
            ...
            !a.get("&gtm"))) {
                ...
                b || (c = M.documentElement.getAttribute("data-tag-assistant-present"),
    ...
    var hc = !1
        ...
        if (P(a, ac) == "cookie") {
            ...
            if (a.get(je)) {
                ...
                if (b = P(a, ce)) {
                    ...
                    g && g != "aw.ds" ? d && (d.ua = !0) : (b = ["1", e, Cc(b)].join("."),
            ...
            a.get(je) && (b = P(a, Se)) && (c = Math.min(R(a, bf), R(a, Zb) * 1E3),

            c = c === 0 ? 0 : Math.min(c, R(a, Te) * 1E3 + c - (new Date).getTime()),
      ...
      , na = function(a, b, c) {
        ...
        if (!a || a.length < 1)
            ...
            for (var d = [], e = 0; e < a.length; e++) {
                ...
                (l == "GA1" || l == "1") && ca.length > 1 ? (g = ca.shift().split("-"),
      ...
      , Gc = function(a, b, c) {
        ...
        for (var d = [], e = [], g, ca = 0; ca < a.length; ca++) {
            ...
            l.H[c] == b ? d.push(l) : g == void 0 || l.H[c] < g ? (e = [l],
      ...
      , rd = function(a, b) {
        ...
        if (b && b.action)
            ...
            if (b.method.toLowerCase() == "get") {
                ...
                b.method.toLowerCase() == "post" && (b.action = qd(a, b.action))
    ...
    function af(a) {
        ...
        if (c && a.get(je)) {
            ...
            if (d * 1E3 + b(a.get(he)) <= (new Date).getTime())
      ...
      , Ke = function(a, b, c, d) {
        ...
        if (g) {
            ...
            case 1:
                ...
                G(String(a.get("trackingId"))) || (ca.clientId = String(a.get(Q)),
            ...
            case 2:
                ...
                if (e.isContainerLoaded(b) || nf >= 20)
    ...
    function td(a, b) {
        ...
        if (a.get(Hd)) {
            ...
            if (c || e || ca || l)
                ...
                a.get(bc) || ye(a.get(Kd)) || g) {
                    ...
                    d.gclsrc && a.data.set(ie, d.gclsrc)) : l && (e = l.split(".")) && e.length === 2 && (J(37),
                    ...
                    c)
                        ...
                        d == -1)
                            ...
                            if (c = be("_gac", !!a.get(cc)))
                                ...
                                c[0] != "1" || c.length != 4 ? J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce, c[3]),
        ...
        a.get(Q) || (b = (b = O.gaGlobal) && b.from_cookie && P(a, ac) !== "cookie" ? void 0 : (b = b && b.vid) && b.search(jd) !== -1 ? b : void 0,
        ...
        if (b.vid == void 0 || a && !b.from_cookie)
    ...
    function pd(a) {
        ...
        if (d && a.get(cc) && (b = M.location.hash)) {
            ...
            for (c = 0; c < b.length; ++c)
                ...
                (D(b[c], "utm_id") || D(b[c], "utm_campaign") || D(b[c], "utm_source") || D(b[c], "utm_medium") || D(b[c], "utm_term") || D(b[c], "utm_content") || D(b[c], "gclid") || D(b[c], "dclid") || D(b[c], "gclsrc") || D(b[c], "wbraid")) && d.push(b[c]);
    ...
    var te = /^(?:(\w+)\.)?(?:(\w+):)?(\w+)$/
      ...
      , sc = function(a) {
        ...
        if (ea(a[0]))
            ...
            b != null && b.length == 4 && (this.da = b[1] || "t0",
            ...
            this.K || (this.A = this.methodName == "create",

            this.i = this.methodName == "require",

            this.g = this.methodName == "provide",

            this.ba = this.methodName == "remove"),

            this.i && (this.aa.length >= 3 ? (this.X = this.aa[1],
    ...
    var u = function(a, b, c) {
      ...
      , cf = function(a, b) {
        ...
        return a && a.indexOf("/") >= 0 ? a : (b || bd(!1)) + "/plugins/ua/" + a
    ...
    Z.D = function(a) {
        ...
        for (Z.fa = []; b.length > 0 && !Z.v(b[0]) && !(b.shift(),
        ...
        try {
            ...
            if (a.u)
                ...
                if (a.A) {
                    ...
                    if (a.da == "t0" && (b = N.create.apply(N, a.aa),
